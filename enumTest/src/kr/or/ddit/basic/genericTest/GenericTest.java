...
/*
 ...
 class 클래스명 <제네릭타입글자>{ 
 	...
 	// 매개변수를 저장할 때 제네릭을 사용할 경우
 	반환값 자료형 메서드명(제네릭타입글자 변수명, ...){
 		...
 	}
 }
 
 -- 제네릭타입글자 (영어 대문자 1글자 사용)
 T ==> Type
 K ==> Key
 V ==> Value
 E ==> Element
...
//		my2.setValue("대한민국"); //다른 종류의 데이터를 사용할 수 없게 한다.
		...
		String myRtn1 = my1.getValue(); //데이터를 꺼내올때 형변환 없이 꺼내올 수 있다.
		System.out.println("제네릭 문자열 반환값: " + myRtn1);
		
		int myRtn2 = my2.getValue();
		System.out.println("제네릭 정수형 반환갑: " + myRtn2);
