...
//		File file1= new File("d:\\d_other\\test.txt"); // 구분문자를 '\'로 사용
		...
		System.out.println("파일일까? : " +file1.isDirectory());
		System.out.println();
		
		File file2 = new File("d:/d_other");
		System.out.println("파일명 : " + file2.getName());
		System.out.println("파일일까? :" + file2.isFile());
		System.out.println("파일일까? :" + file2.isDirectory());
		System.out.println();
		...
		System.out.println("파일일까? :" + file3.isDirectory());
		System.out.println();
		...
		System.out.println("파일일까? :" + file4.isDirectory());
		System.out.println();
		System.out.println("----------------------------------------------");
